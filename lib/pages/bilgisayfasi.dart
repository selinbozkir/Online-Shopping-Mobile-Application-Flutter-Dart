...
class BilgiListPage extends StatefulWidget {
  const BilgiListPage({required this.userid});
  final userid;

  @override
  State<BilgiListPage> createState() => _BilgiListPageState();
}

class _BilgiListPageState extends State<BilgiListPage> {
  @override
